...
//  Blott
//
//  Created by Doc990 App on 2024-01-04.
//
...
struct WebView: View {
    ...
    init(url: String) {
          self.webViewModel = WebViewModel(url: url)
      }

    
    var body: some View {

        if webViewModel.onBackPressed {
            RegisterView()
        }else {
            NavigationView {
                ZStack {
                ...
                .navigationBarItems(leading: Button(action: {
                    ...
                    if webViewModel.canGoBack {
                        ...
                        Image(systemName: "chevron.left")
                                        ...
                                        .frame(width: 24, height: 24)
                            .onTapGesture {
                                webViewModel.onBackPressed = true
                                RegisterView()
                            }
                    }
                })
...
struct PharmacyWebView_Previews: PreviewProvider {
...
class WebViewModel: ObservableObject {
    ...
    @Published var onBackPressed: Bool = false
